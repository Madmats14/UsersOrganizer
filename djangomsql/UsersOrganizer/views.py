...
def home(request):
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            login(request, user)
            messages.success(request, "You have been connected!")
...
def add_record(request):
    ...
    if request.user.is_authenticated:
        ...
        messages.success(request, "You are not logged!")
        return redirect('home')
...
def edit_record(request, pk):
    if request.user.is_authenticated:
        ...
        messages.success(request, 'Must log in!')
        return redirect('home')
